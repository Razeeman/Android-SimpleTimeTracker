...
import kotlinx.android.synthetic.main.change_record_type_color_item_layout.view.*
...
class ChangeRecordTypeColorAdapterDelegate(
    ...
    inner class RunningRecordsViewHolder(parent: ViewGroup) :
        BaseRecyclerViewHolder(parent, R.layout.change_record_type_color_item_layout) {
