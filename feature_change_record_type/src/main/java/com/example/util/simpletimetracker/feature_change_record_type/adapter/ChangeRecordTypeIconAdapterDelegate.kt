...
import kotlinx.android.synthetic.main.change_record_type_icon_item_layout.view.*
...
class ChangeRecordTypeIconAdapterDelegate(
    ...
    inner class RunningRecordsViewHolder(parent: ViewGroup) :
        BaseRecyclerViewHolder(parent, R.layout.change_record_type_icon_item_layout) {
